---
title: "GAPMINDE | LIFE EXPECTANCIES 2007"
format: dashboard
theme: lux
---
...
gap_07 <- gap_07 %>% 
  mutate(country_code=
           countrycode(country, 
                       "country.name", 
                       "iso3c"))
def_codes <- setdiff(gap_07$country_code, country_shapes$adm0_a3)
#only some tiny islands that are not identified. That makes sense because they are too tiny. We are not gouing to care much about these for now.
...
value_box(
  ...
  p(paste0("(", highest_life_exp_country, ")")) #stands for paragraph
)
```
...
value_box(
  ...
  showcase = bsicons::bs_icon("life-preserver"),
...
An example of one Hans Rosling videos is shown below

<iframe width="560" height="315" src="https://www.youtube.com/embed/hVimVzgtD6w?si=HnR3arU_F0Lj1AhX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
